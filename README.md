...
![Mapping Entries](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fgithub.com%2Fdem0nx309%2Fanibridge-mappings%2Freleases%2Fdownload%2Fv3%2Fstats.json&query=%24.summary.target_descriptors_str&style=for-the-badge&label=Mapping%20Entries&labelColor=%231f2937&color=%2322c55e&cacheSeconds=10800)
![Distinct IDs](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fgithub.com%2Fdem0nx309%2Fanibridge-mappings%2Freleases%2Fdownload%2Fv3%2Fstats.json&query=%24.summary.distinct_descriptors_str&style=for-the-badge&label=Distinct%20IDs&labelColor=%231f2937&color=%233b82f6&cacheSeconds=10800)
[![Download Mappings](https://img.shields.io/badge/Download%20Mappings-v3-2b8a3e?style=for-the-badge)](https://github.com/dem0nx309/anibridge-mappings/releases/tag/v3)

anibridge-mappings is a dataset and pipeline for mapping episode-level relationships between anime entries across various databases, including AniDB, AniList, HyakAnime, MAL, TMDB, TVDB, and IMDB. The schema was designed for use in the [AniBridge](https://anibridge.eliasbenb.dev) project, but the dataset is open for anyone to use and contribute to.
...
[Releases](https://github.com/dem0nx309/anibridge-mappings/releases) are published from this fork whenever the release workflow runs successfully, and you can explore the upstream dataset interactively at <https://mappings.anibridge.eliasbenb.dev>.
...
- [`mappings.min.json`](https://github.com/dem0nx309/anibridge-mappings/releases/download/v3/mappings.min.json): the main dataset in minified JSON format.
- [`provenance.zip`](https://github.com/dem0nx309/anibridge-mappings/releases/download/v3/provenance.zip): a zip file containing provenance data for each mapping entry.
- [`stats.json`](https://github.com/dem0nx309/anibridge-mappings/releases/download/v3/stats.json): summary counts about the dataset.
...
| [HyakAnime Public API](https://api-v5.hyakanime.fr/anime/1)                                       | Yes      | Yes         | No               | HyakAnime, AniList                    |
...
- `provider`: one of `anidb`, `anilist`, `hyakanime`, `imdb_movie`, `imdb_show`, `mal`, `tmdb_show`, `tmdb_movie`, `tvdb_show`.
...
- `scope`: is optional and used to denote some type of subsetting. It is important to understand that this schema is flexible, different providers will have different notations for the scope:
  ...
  - `anilist|hyakanime|mal`: these omit scopes, as they don't have a concept of seasons or episode types in the same way (e.g. `anilist:12345`).
